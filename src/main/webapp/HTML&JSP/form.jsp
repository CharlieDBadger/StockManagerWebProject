            ...
            <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink2">
                            <li><a class="dropdown-item" href="/StockManagerWebProject/UserListServlet">Usuarios</a>
                            </li>
                            <li><a class="dropdown-item" href="Ref2">Clientes</a></li>
                            <li><a class="dropdown-item" href="Ref3">Articulos</a></li>
            ...
            <form class="header-form container" id="createUser" action="/StockManagerWebProject/UserServlet"
                ...
                <div class="container">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="dni" id="dni" class="form-control" placeholder="Introduce DNI"
                            required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="idUser" id="idUser" class="form-control"
                            placeholder="No se le ha asignado un ID">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" pattern="[0-9]{9}" maxlength="9" minlength="9" name="telephone" id="telephone"
                    ...
                    <div class="form-check-inline text-center">
                        ...
                        <input type="radio" name="gender" id="male" value="Masculino" class="form-control"
                            placeholder=Masculino required>
                        <label class="text-primary" for="male"><strong>Femenino</strong></label><br>
                        <input type="radio" name="gender" id="female" value="Femenino" class="form-control"
                            placeholder=Femenino required>
                        <label class="text-primary" for="male"><strong>Otro</strong></label><br>
                        <input type="radio" name="gender" id="other" value="Otro" class="form-control" placeholder=Otro
                            required>
                    </div>
                    <br><br>
