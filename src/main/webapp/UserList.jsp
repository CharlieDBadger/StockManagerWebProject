		...
		<div class="menu-container">
			<div class="form-group" align="center">
				<div class="dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
						<a class="dropdown-item" href="User.jsp">Usuarios</a> <a
							class="dropdown-item" href="Cliente.jsp">Clientes</a> <a
							class="dropdown-item" href="Article.jsp">Articulos</a> <a
							class="dropdown-item" href="Supplier.jsp">Proveedores</a> <a
							class="dropdown-item" href="Factura.jsp">Factura</a> <a
							class="dropdown-item" href="Entry.jsp">Entrada</a>
					</div>
					<button type="button" class="btn btn-primary"
						data-toggle="dropdown">Listados</button>

					<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
						<a class="dropdown-item" href="UserList.jsp">Usuarios</a> <a
							class="dropdown-item" href="ClientList.jsp">Clientes</a> <a
							class="dropdown-item" href="ArticleList.jsp">Articulos</a> <a
							class="dropdown-item" href="MovArticleList.jsp">Mov.
							Articulos</a> <a class="dropdown-item" href="SupplierList.jsp">Proveedores</a>
					</div>
				...
				<form id="manipulateUser"
					action="/StockManagerWebProject/UserServlet" method="get">
					<table>
						<thead>
							<tr>
								<th>Borrar</th>
