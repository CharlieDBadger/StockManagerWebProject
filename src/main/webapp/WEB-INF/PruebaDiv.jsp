        ...
        <div class="menu-container">
            <div class="form-group" align="center">
                <div class="dropdown">
                    ...
                    <button type="submit" class="btn btn-primary" data-toggle="dropdown">Altas</button>
                    ...
                    <button type="submit" class="btn btn-primary" data-toggle="dropdown">Bajas</button>
                    ...
                    <button type="submit" class="btn btn-primary" data-toggle="dropdown">Consultas</button>
                ...
                <h2 class="text-center col-12 mb-4 mt-4">Bienvenido! <%= session.getAttribute("usuario") %>
                </h2>
